                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
                    ...
                    >
                        ...
                        <p className="text-gray-700 mb-6 text-center text-md md:text-lg">
                            Congratulations to this year's playoff qualifiers! Below are the playoff teams and seeds for both leagues. <strong>Seeds 2-6 will play Week 15, with the top two scoring teams moving on to weeks 16 and 17. The final 4 teams will play a two week battle two determine final results.</strong>
                        </p>

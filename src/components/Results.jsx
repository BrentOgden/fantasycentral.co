...
import away from '../assets/packers.png';    // one level up
    ...
    <section className="p-10 space-y-10">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded p-4 shadow-2xl">
          ...
          <p className='text-black text-center'>Jeremy Ogden (10-4)</p>
        </div>
        <div className="bg-white rounded p-4 shadow-2xl">
          <h3 className="text-xl text-[#8e2034] font-semibold text-center">2nd Place</h3>
          <p className='text-black text-center'>Brent Ogden | Cody Box (8-6)</p>
        </div>
        <div className="bg-white rounded p-4 shadow-2xl">
          <h3 className="text-xl text-[#8e2034] font-semibold text-center">3rd Place</h3>
          <p className='text-black text-center'>Justin Gutierrez | Freeman Puthavongsa | Met Nagatani (7-7)</p>
        </div>
      </div>

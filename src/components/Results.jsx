...
import home from '../assets/chiefs.png';  // one level up
    ...
    <section className="p-10 space-y-10">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded p-4 shadow-2xl">
          ...
          <p className='text-black text-center'>Justin Gutierrez | Cody Box (12-4)</p>
        </div>
        <div className="bg-white rounded p-4 shadow-2xl">
          <h3 className="text-xl text-[#8e2034] font-semibold text-center">2nd Place</h3>
          <p className='text-black text-center'>Brent Ogden | Jeremy Ogden (11-5)</p>
        </div>
        <div className="bg-white rounded p-4 shadow-2xl">
          <h3 className="text-xl text-[#8e2034] font-semibold text-center">3rd Place</h3>
          <p className='text-black text-center'>Met Nagatani (10-6)</p>
        </div>
      </div>

...
import home from '../assets/raiders.png';  // one level up
    ...
    <section className="p-10 space-y-10">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded p-4 shadow-2xl">
          ...
          <p className='text-black text-center'>Cody Box (10-6) | Justin Gutierrez</p>
        </div>
        <div className="bg-white rounded p-4 shadow-2xl">
          <h3 className="text-xl text-[#8e2034] font-semibold text-center">2nd Place</h3>
          <p className='text-black text-center'>Several Tied (9-7)</p>
        </div>
        <div className="bg-white rounded p-4 shadow-2xl">
          <h3 className="text-xl text-[#8e2034] font-semibold text-center">3rd Place</h3>
          <p className='text-black text-center'>Did Not Play</p>
        </div>
      </div>
